...
call quit ; llame a nuestra i m p r e s i n de n m e r o s enteros con f u n c i n de avance de l n e a
call iprintLF ; llama a nuestra f u n c i n de salida