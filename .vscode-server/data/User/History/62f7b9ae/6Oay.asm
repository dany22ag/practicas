...
%include 'practica9/functions.asm'

SECTION .data
msg1 db 'Introduce tu nombre : ', 0h ; cadena de mensaje solicitando i n f o r m a c i n al usuario
msg2 db 'Hola , ', 0h ; cadena de mensaje que se u s a r d e s p u s de que el usuario haya ingresado su nombre
