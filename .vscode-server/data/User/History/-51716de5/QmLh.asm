...
print :
5 push eax ; conserva eax en la pila para restaurarlo
despu és de que se ejecute la funci ón
6 push ecx ; conserva ecx en la pila para restaurarlo
despu és de que se ejecute la funci ón
7 push edx ; conserva edx en la pila para restaurarlo
despu és de que se ejecute la funci ón
8 push esi ; conserva esi en la pila para restaurarlo
despu és de que se ejecute la funci ón
9 mov ecx , 0 ; contador de cuantos bytes necesitamos
imprimir al final
