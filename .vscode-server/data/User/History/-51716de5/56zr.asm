...
; ------------------------------------------
; void iprint ( Integer number )
; Funci ón de impresi ón de nú meros enteros ( itoa )
iprint :
push eax ; conserva eax en la pila para restaurarlo despu és de que se ejecute la funci ón
push ecx ; conserva ecx en la pila para restaurarlo despu és de que se ejecute la funci ón
push edx ; conserva edx en la pila para restaurarlo despu és de que se ejecute la funci ón
push esi ; conserva esi en la pila para restaurarlo despu és de que se ejecute la funci ón
mov ecx , 0 ; contador de cuantos bytes necesitamos imprimir al final
